...
public class MenuManager {
    ...
    private final MenuItem btnPrev = new MenuItem("<<", PREV_ACTION);
    private final MenuItem btnNext = new MenuItem(">>", NEXT_ACTION);
    private final MenuItem btnCancel = new MenuItem("Cancel", CANCEL_ACTION);
